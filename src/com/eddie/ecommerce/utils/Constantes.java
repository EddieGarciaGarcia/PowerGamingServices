...
public interface Constantes {
    ...
    public static final String CACHE_IDIOMA="Idioma";
    public static final String CACHE_PLATAFORMA = "Plataforma";
    public static final String CACHE_TIPO_EDICION = "TipoEdicion";
}
